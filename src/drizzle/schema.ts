...
export const user = mysqlTable('user', {
    ...
    role: varchar("role", { length: 255, enum: ['super_admin', 'admin', 'manager', 'author', 'user'] }).notNull().default("user"),
    status: varchar("status", { length: 255, enum: ['active', 'inactive'] }).notNull().default("active"),
